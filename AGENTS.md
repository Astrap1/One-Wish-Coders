...
12. **Done: Version 3 LiDAR self-filter (2026-09-26).** The closest false returns from the corrected live corridor run, `(-1.56, -0.11, -0.42)` and `(-0.99, 1.27, -0.43)` in `lidar_link`, are now rejected by an inclusive 1.75 m circular footprint envelope around V3's centre mast. The test also keeps a point at 1.76 m, proving genuine external obstacles are retained. Autonomy continues to receive all non-self returns and must not suppress external obstacles to compensate.
