...
VEHICLES = {
    ...
    # Version 3's current autonomy-tuning profile uses confirmed LiDAR returns
    # for planning and Safety route validation. The terrain map remains on the
    # dashboard as operator reference only; Person 1 holds proposed speed low
    # until mobility/PID tuning is signed off.
    "v3": {"model": "hovercraft_v3", "urdf": "hovercraft_v3.urdf",
           ...
           "planner": {"lidar_only_navigation": True,
           ...
           "follower": {"max_linear_speed": 1.2, "max_angular_speed": 0.30,
                        "lookahead_distance": 2.0, "heading_gain": 0.45,
                        "rotate_in_place_angle": 0.60,
                        "slow_down_distance": 5.0,
                        "zone_speed_limits_mps": [0.0],
                        "brake_decel_mps2": 1.0, "lateral_accel_limit_mps2": 0.35,
                        "yaw_rate_damping": 0.8,
                        "corner_preview_sample_distance_m": 4.0,
                        "turn_brake_angle_rad": 0.35,
                        "turn_brake_speed_mps": 0.45,
                        "lookahead_time_s": 1.5, "reaction_time_s": 1.0,
                        "obstacle_detection_range_m": 30.0,
                        "obstacle_clearance_m": 2.0},
           "safety": {"costmap_reference_only": True,
                      "zone_speed_limits_mps": [0.0], "brake_decel_mps2": 1.0,
