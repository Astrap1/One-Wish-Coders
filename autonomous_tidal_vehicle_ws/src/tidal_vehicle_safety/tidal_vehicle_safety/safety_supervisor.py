...
class SafetySupervisor(Node):
    ...
    def _declare_parameters(self) -> None:
        defaults = {
            ...
            "wheel_energy_percent_per_m": 0.025,
    ...
    def _estimator_config(self) -> ReturnEstimatorConfig:
        return ReturnEstimatorConfig(
            ...
            wheel_cost_max=int(self._parameter("wheel_cost_max")),
            elevated_hover_cost_min=int(self._parameter("elevated_hover_cost_min")),
            wheel_energy_percent_per_m=self._parameter("wheel_energy_percent_per_m"),
            hover_energy_percent_per_m=self._parameter("hover_energy_percent_per_m"),
            wheel_nominal_speed_mps=self._parameter("wheel_nominal_speed_mps"),
