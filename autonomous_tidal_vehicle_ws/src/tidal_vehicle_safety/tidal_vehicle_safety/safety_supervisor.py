...
class SafetySupervisor(Node):
    ...
    def _estimator_config(self) -> ReturnEstimatorConfig:
        return ReturnEstimatorConfig(
            ...
            base_energy_percent_per_m=self._parameter("base_energy_percent_per_m"),
            ...
            nominal_speed_mps=self._parameter("return_nominal_speed_mps"),
