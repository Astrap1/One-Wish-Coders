    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'tidal_vehicle_interfaces.msg.SafetyStatus')
            logger.debug(
...
class SafetyStatus(metaclass=Metaclass_SafetyStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.return_required = kwargs.get('return_required', bool())
    ...
    def __eq__(self, other):
        ...
        if self.reason != other.reason:
            return False
        if self.return_required != other.return_required:
            return False
        return True
    ...
    def return_required(self):
        """Message field 'return_required'."""
        return self._return_required

    @return_required.setter
    def return_required(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'return_required' field must be of type 'bool'"
        self._return_required = value
