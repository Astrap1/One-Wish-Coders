...
static const _SafetyStatus_type_support_symbol_names_t _SafetyStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidal_vehicle_interfaces, msg, SafetyStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tidal_vehicle_interfaces, msg, SafetyStatus)),
  }
};
...
{
  return &::tidal_vehicle_interfaces::msg::rosidl_typesupport_cpp::SafetyStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tidal_vehicle_interfaces, msg, SafetyStatus)() {
  return get_message_type_support_handle<tidal_vehicle_interfaces::msg::SafetyStatus>();
}
