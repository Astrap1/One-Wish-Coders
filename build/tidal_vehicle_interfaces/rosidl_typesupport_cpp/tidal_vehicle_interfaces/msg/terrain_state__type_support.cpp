...
static const _TerrainState_type_support_symbol_names_t _TerrainState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidal_vehicle_interfaces, msg, TerrainState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tidal_vehicle_interfaces, msg, TerrainState)),
  }
};
...
{
  return &::tidal_vehicle_interfaces::msg::rosidl_typesupport_cpp::TerrainState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tidal_vehicle_interfaces, msg, TerrainState)() {
  return get_message_type_support_handle<tidal_vehicle_interfaces::msg::TerrainState>();
}
